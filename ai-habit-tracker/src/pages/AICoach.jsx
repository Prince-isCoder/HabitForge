    ...
    <div className="font-['DM_Sans',_sans-serif] bg-gradient-to-br from-background via-surface to-background min-h-screen flex items-center justify-center p-6">
      <style>{`
        ...
        .header-icon-wrap {
          width: 42px;
          height: 42px;
          @apply bg-gradient-to-br from-primary to-primaryHover text-primaryContent rounded-xl flex items-center justify-center shadow-lg shadow-primary/30 shrink-0;
        }
        ...
        .msg-avatar.ai {
          @apply bg-gradient-to-br from-primary to-primaryHover text-primaryContent shadow-lg shadow-primary/20;
        }
        ...
        .send-btn {
          width: 46px;
          height: 46px;
          @apply bg-gradient-to-br from-primary to-primaryHover text-primaryContent border-none rounded-[13px] cursor-pointer flex items-center justify-center transition-all shadow-lg shadow-primary/30 shrink-0;
        }
