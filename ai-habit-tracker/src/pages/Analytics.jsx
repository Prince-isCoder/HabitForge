...
const CustomTooltip = ({ active, payload, label }) => {
  if (active && payload?.length) return (
    <div className="bg-surface border border-primary/25 rounded-xl p-[10px_14px] text-[13px] text-text">
  ...
  return (
    <div className="min-h-screen bg-background text-text p-8 font-['Outfit']">
      <style>{`
        ...
        .an-card { background: var(--surface); border: 1px solid var(--border); border-radius: 18px; padding: 24px; transition: border-color 0.2s; }
      ...
      <div className="mb-8">
        <h1 className="text-[28px] font-bold text-text tracking-tight mb-1.5">Analytics</h1>
        <p className="text-[14px] text-textMuted m-0">Your habit performance at a glance</p>
      </div>
        ...
        <>
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-4 mb-6">
            {[
              ...
              <div key={i} className={`bg-surface border ${s.border} rounded-[18px] p-[22px]`}>
                ...
                <div className="text-[30px] font-bold text-text tracking-tight">{s.val}</div>
          ...
          <div className="an-card mb-6">
            ...
            <ResponsiveContainer width="100%" height={280}>
              <AreaChart data={data.weeklyData}>
                ...
                <XAxis dataKey="day" tick={{ fill: "var(--textMuted)", fontSize: 12, fontFamily: "Outfit" }} axisLine={false} tickLine={false} />
                <YAxis tick={{ fill: "var(--textMuted)", fontSize: 12, fontFamily: "Outfit" }} axisLine={false} tickLine={false} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="an-card !border-primary/20 !bg-primary/5">
              <div className="text-[12px] font-bold tracking-wider uppercase text-primary mb-2.5">💡 Insight</div>
            ...
            <div className="an-card !border-cyan-500/20 !bg-cyan-500/5">
              <div className="text-[12px] font-bold tracking-wider uppercase text-cyan-500 mb-2.5">🚨 Alert</div>
