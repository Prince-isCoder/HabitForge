              ...
              <div className="flex items-center justify-between p-5 bg-surfaceLight/30 rounded-2xl border border-border/50 hover:border-primary/20 transition-all group">
                <div className="flex gap-4 items-center">
                   <div className="w-10 h-10 bg-surface rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                      {themeMode === 'dark' ? <Moon size={20} className="text-primary" /> : themeMode === 'light' ? <Sun size={20} className="text-orange-400" /> : <Monitor size={20} className="text-cyan-500" />}
                   </div>
                   <div>
                     <div className="text-sm font-bold">Theme Mode</div>
                     <div className="text-xs text-textMuted">Personalize your visual experience</div>
                   </div>
                </div>

                <div className="flex items-center bg-background border border-border/50 rounded-2xl p-1.5 shadow-sm">
                  {[
