        ...
        <div className="xl:col-span-2 space-y-8">
          ...
          <div className="card !p-8">
            ...
            <div className="space-y-6">
              <div>
                <label className="text-[10px] font-bold text-textMuted uppercase tracking-widest ml-1 block mb-4">Interface Theme</label>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <button
                    onClick={() => setTheme("light")}
                    className={`flex items-center gap-4 p-4 rounded-2xl border transition-all text-left ${theme === 'light' ? 'bg-primary/5 border-primary shadow-sm' : 'bg-surface border-border hover:border-primary/20'}`}
                  >
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all ${theme === 'light' ? 'bg-primary text-white' : 'bg-surfaceLight text-textMuted'}`}>
                      <Sun size={24} />
                    </div>
                    <div>
                  ...
                  <button
                    ...
                    className={`flex items-center gap-4 p-4 rounded-2xl border transition-all text-left ${theme === 'dark' ? 'bg-primary/5 border-primary shadow-sm' : 'bg-surface border-border hover:border-primary/20'}`}
                  >
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all ${theme === 'dark' ? 'bg-primary text-white' : 'bg-surfaceLight text-textMuted'}`}>
                      <Moon size={24} />
                    </div>
                    <div>
                      <div className="text-sm font-bold">Dark Mode</div>
                      <div className="text-xs text-textMuted">Easy on the eyes in low light</div>
                    </div>
                  </button>
                </div>
              </div>
