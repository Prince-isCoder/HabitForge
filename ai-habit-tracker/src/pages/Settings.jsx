              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <button
                    ...
                    className={`flex items-center gap-4 p-4 rounded-2xl border transition-all text-left ${theme === 'light' ? 'bg-primary/5 border-primary shadow-sm' : 'bg-surface border-border hover:border-primary/30'}`}
                  >
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${theme === 'light' ? 'bg-primary text-white' : 'bg-surfaceLight text-textMuted'}`}>
                      <Sun size={24} />
                    </div>
                    <div className="flex-1">
                      <div className="text-sm font-bold">Light Mode</div>
                      <div className="text-xs text-textMuted">Clean & bright experience</div>
                    </div>
                  ...
                  <button
                    ...
                    className={`flex items-center gap-4 p-4 rounded-2xl border transition-all text-left ${theme === 'dark' ? 'bg-primary/5 border-primary shadow-sm' : 'bg-surface border-border hover:border-primary/30'}`}
                  >
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${theme === 'dark' ? 'bg-primary text-white' : 'bg-surfaceLight text-textMuted'}`}>
                      <Moon size={24} />
                    </div>
                    <div className="flex-1">
