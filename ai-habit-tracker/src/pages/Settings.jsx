              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button
                    ...
                    className={`flex flex-col gap-3 p-4 rounded-2xl border transition-all text-left group ${theme === 'light' ? 'bg-primary/5 border-primary shadow-sm' : 'bg-surface border-border hover:border-primary/20'}`}
                  >
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-textMuted font-medium uppercase tracking-wider">Clean & Bright</div>
                    </div>
                  </button>

                  <button
                    onClick={() => setTheme('dark')}
                    className={`flex flex-col gap-3 p-4 rounded-2xl border transition-all text-left group ${theme === 'dark' ? 'bg-primary/5 border-primary shadow-sm' : 'bg-surface border-border hover:border-primary/20'}`}
                  >
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-textMuted font-medium uppercase tracking-wider">Better for night</div>
                    </div>
                  </button>
                </div>
              </div>
