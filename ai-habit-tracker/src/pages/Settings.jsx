        ...
        <div className="xl:col-span-2 space-y-8">
          ...
          <div className="card !p-8">
            ...
            <div className="space-y-4">
              <div className="flex flex-col md:flex-row md:items-center justify-between p-6 bg-surfaceLight/30 rounded-3xl border border-border/50 gap-6">
                <div className="flex gap-4 items-center">
                   <div className="w-12 h-12 bg-surface rounded-2xl flex items-center justify-center shadow-sm">
                      {theme === 'dark' ? <Moon size={22} className="text-primary" /> : <Sun size={22} className="text-orange-400" />}
                   </div>
                   <div>
                     <div className="text-base font-bold">Appearance</div>
                     <div className="text-xs text-textMuted">Choose how HabitForge looks for you</div>
                   </div>
                </div>
                ...
                <div className="flex bg-surface p-1.5 rounded-2xl border border-border/50 shadow-sm">
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition-all ${theme === 'light' ? 'bg-primary text-white shadow-lg shadow-primary/20' : 'text-textMuted hover:text-text'}`}
                  >
                    <Sun size={14} /> Light
                  </button>
                  <button
                    onClick={() => setTheme('dark')}
                    className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition-all ${theme === 'dark' ? 'bg-primary text-white shadow-lg shadow-primary/20' : 'text-textMuted hover:text-text'}`}
                  >
                    <Moon size={14} /> Dark
                  </button>
                </div>
