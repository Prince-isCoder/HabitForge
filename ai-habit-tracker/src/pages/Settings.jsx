            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <button
                  ...
                  className={`p-4 rounded-2xl border-2 transition-all text-left group ${theme === 'light' ? 'border-primary bg-primary/5' : 'border-border bg-surfaceLight/30 hover:border-primary/20'}`}
                >
                  ...
                  <div className="text-xs text-textMuted">Crisp and clean</div>
                </button>

                <button
                  onClick={() => setTheme('dark')}
                  className={`p-4 rounded-2xl border-2 transition-all text-left group ${theme === 'dark' ? 'border-primary bg-primary/5' : 'border-border bg-surfaceLight/30 hover:border-primary/20'}`}
                >
                  <div className="w-10 h-10 bg-[#0B0E14] rounded-xl flex items-center justify-center mb-4 shadow-sm group-hover:scale-110 transition-transform border border-white/5">
