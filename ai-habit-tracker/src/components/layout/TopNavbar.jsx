...
const TopNavbar = () => {
  ...
  return (
    <header style={{ height: 68, background: "var(--surface)", backdropFilter: "blur(20px)", borderBottom: "1px solid var(--border)", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 28px", position: "sticky", top: 0, zIndex: 20, fontFamily: "'Outfit',sans-serif", transition: "background 0.2s, border-color 0.2s" }}>
      ...
      <div style={{ position: "relative", flex: 1, maxWidth: 360 }}>
        ...
        <input
          ...
          style={{ width: "100%", background: "var(--background)", border: "1px solid var(--border)", borderRadius: 99, paddingLeft: 38, paddingRight: 16, paddingTop: 9, paddingBottom: 9, fontSize: 13, color: "var(--text)", fontFamily: "'Outfit',sans-serif", outline: "none", boxSizing: "border-box", transition: "all 0.2s" }}
        />
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        {/* Bell */}
        <button style={{ width: 38, height: 38, background: "var(--background)", border: "1px solid var(--border)", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", position: "relative", transition: "all 0.2s" }}>
          <div style={{ position: "absolute", top: 8, right: 8, width: 7, height: 7, background: "#ef4444", borderRadius: "50%", border: "2px solid var(--surface)" }} />
