  ...
  return (
    <aside className="w-[260px] min-h-screen bg-surface border-r border-border flex flex-col sticky top-0 z-30 shrink-0">
      ...
      <div className="p-8 flex items-center gap-3">
        <div className="w-10 h-10 bg-primary rounded-xl flex items-center justify-center text-xl shadow-lg shadow-primary/20 shrink-0 text-[var(--primary-content)]">
          🔥
        </div>
        <div>
      ...
      <div className="p-4 mt-auto">
        <div className="upgrade-card">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center font-bold text-[var(--primary-content)] shadow-md shadow-primary/20">
